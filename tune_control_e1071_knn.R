...
################################################################################
################################################################################
################## Accuracy computation, boxplots and tests
################################################################################
#
...
for (i in 1:length(seeds)){
  boxplot(Accuracy.M.Accuracy,
          ...
          #main=paste(" "), 
          xlab="tuning error function", ylab=" ",names=c("Error.rate", "SMAE", 
                                                         "SMAE.int.20",
                                                         "SMAE.int.30",
                                                         "SMAE.int.40",
                                                         "SMAE.int.50",
...
p4<-shapiro.test(Accuracy.M.MAE.int.90)$p.value
p5<-shapiro.test(Accuracy.M.MAE.int.100)$p.value
p6<-shapiro.test(Accuracy.M.MAE.int.110)$p.value
p7<-shapiro.test(Accuracy.M.MAE.int.120)$p.value  # all are > 0.05

t.test(Accuracy.M.Accuracy,Accuracy.M.MAE,paired=TRUE,alternative="less")$p.value
t.test(Accuracy.M.Accuracy,Accuracy.M.MAE.int.80,paired=TRUE,alternative="less")$p.value
t.test(Accuracy.M.Accuracy,Accuracy.M.MAE.int.90,paired=TRUE,alternative="less")$p.value
t.test(Accuracy.M.Accuracy,Accuracy.M.MAE.int.100,paired=TRUE,alternative="less")$p.value
t.test(Accuracy.M.Accuracy,Accuracy.M.MAE.int.110,paired=TRUE,alternative="less")$p.value
t.test(Accuracy.M.Accuracy,Accuracy.M.MAE.int.120,paired=TRUE,alternative="less")$p.value

################################################################################
################################################################################
################## SMAE computation, boxplots and tests
################################################################################
#
...
p4<-shapiro.test(SMAE.M.MAE.int.90)$p.value
p5<-shapiro.test(SMAE.M.MAE.int.100)$p.value
p6<-shapiro.test(SMAE.M.MAE.int.110)$p.value
p7<-shapiro.test(SMAE.M.MAE.int.120)$p.value  # all are > 0.05

t.test(SMAE.M.MAE,SMAE.M.Accuracy,paired=TRUE,alternative="less")$p.value
t.test(SMAE.M.MAE,SMAE.M.MAE.int.80,paired=TRUE,alternative="less")$p.value
t.test(SMAE.M.MAE,SMAE.M.MAE.int.90,paired=TRUE,alternative="less")$p.value
t.test(SMAE.M.MAE,SMAE.M.MAE.int.100,paired=TRUE,alternative="less")$p.value
t.test(SMAE.M.MAE,SMAE.M.MAE.int.110,paired=TRUE,alternative="less")$p.value
t.test(SMAE.M.MAE,SMAE.M.MAE.int.120,paired=TRUE,alternative="less")$p.value
...
save(tuned.knn.e1071.Accuracy,
     tuned.knn.e1071.MAE,
     tuned.knn.e1071.MAE.int.80,
     tuned.knn.e1071.MAE.int.90,
     tuned.knn.e1071.MAE.int.100,
     tuned.knn.e1071.MAE.int.110,
     tuned.knn.e1071.MAE.int.120,
     #
     pred.tuned.knn.e1071.Accuracy,
     pred.tuned.knn.e1071.MAE,
     pred.tuned.knn.e1071.MAE.int.80,
     pred.tuned.knn.e1071.MAE.int.90,
     pred.tuned.knn.e1071.MAE.int.100,
     pred.tuned.knn.e1071.MAE.int.110,
     pred.tuned.knn.e1071.MAE.int.120,
     #
     Conf.mat.tuned.knn.e1071.Accuracy,
     Conf.mat.tuned.knn.e1071.MAE,
     Conf.mat.tuned.knn.e1071.MAE.int.80,
     ...
     SMAE.int.120.M.MAE.int.120,
     #
     file="tune_control_e1071_knn.RData"
)
